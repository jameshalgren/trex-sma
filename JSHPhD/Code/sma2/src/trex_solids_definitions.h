...
//mlv	**nstackch,			//present number of layers in the channel sediment stack [link][node]
	...
	*nswov,				//Number of overland soilds loads [isolid]
	**swovopt,			//Overland solids load option (0=input as kg/day, 1=input a g/m3) [isolid]
	**swovrow,			//Overland solids load row number [isolid][iswov]
	**swovcol,			//Overland solids load column number [isolid][iswov]
	**nswovpairs,		//Number of pairs (load and time) in a overland solids load time series [isolid][iswch]
	**swovpoint,		//pointer to current position for an overland solids load function [isolid][iswch]

	*nswch,				//Number of channel soilds loads [isolid]
	**swchopt,			//Channel solids load option (0=input as kg/day, 1=input a g/m3) [isolid]
	**swchlink,			//Channel link for solids loads [isolid][iswch]
	**swchnode,			//Channel node for solids loads [isolid][iswch]
	**nswchpairs,		//Number of pairs of channel solids loads and time [isolid][iswch]
	**swchpoint,		//pointer to current position for a channel solids load function
...
float
	...
	***swov,			//Value for an overland solids load [isolid][iload][ipair]
	***swovtime,		//Time break for an overland solids load [isolid][iload][ipair]

	***swch,			//Value for a channel solids load [isolid][iload][ipair]
	***swchtime,		//Time break for a channel solid load [isolid][iload][ipair]
	...
	*ntswov,	//next time to update overland solids loads [isolid]
	*ntswch,	//next time to update channel solids loads [isolid]
	*ntsbc,		//next time to update solids boundary conditions [isolid]

	**nswovt,		//next (upper) interval time for overland sediment load time series [isolid][iload]
	**pswovt,		//prior (lower) interval time for overland sediment load time series [isolid][iload]
	**bswov,		//intercept for overland sediment load interpolation [isolid][iload]
	**mswov,		//slope for overland sediment load interpolation [isolid][iload]
	**swovinterp,	//temporally interpolated overland sediment load [isolid][iload]
