...
void ComputeFinalStateSolids(void)
{
            ...
            if (imask[i][j] != nodatavalue)
            {
                ...
                for (isolid = 1; isolid <= nsolids; isolid++)
                {
                    ...
                    finalsolidsov[isolid][i][j][0] =
                        (float) (csedov[isolid][i][j][0] * hov[i][j] *
                                 (w * w - achsurf) / 1000.0);
            ...
            for (j = 1; j <= nnodes[i]; j++)
            {
                ...
                for (isolid = 1; isolid <= nsolids; isolid++)
                {
                    ...
                    finalsolidsch[isolid][i][j][0] =
                        (float) (csedch[isolid][i][j][0] * achcross * lch /
                                 1000.0);
                    ...
                    if (qchoutlet[i] > 0 && j == nnodes[i])
                    {
                        ...
                        totaladvsedoutch[0][qchoutlet[i]] =
                            totaladvsedoutch[0][qchoutlet[i]] +
                        ...
                        totaldspsedoutch[0][qchoutlet[i]] =
                            totaldspsedoutch[0][qchoutlet[i]] +
