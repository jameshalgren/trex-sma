...
void ComputeChannelTopology(void)
{
    ...
    int **uplinkflag;           //flag to indicate grid location is a valid upstream link
                    ...
                    if (imask[j][k] > 1 && uplinkflag[j][k] == 1)
                    {
                        ...
                        if (uplink < i) //recall: i is the current link number
                        {
                            ...
                            if (upnode == nnodes[uplink])
                            {
                                ...
                                {
                                    if ((k - col) == -1)
                                        nupbranches[i][8] = uplink;
                                    if ((k - col) == 0)
                                        nupbranches[i][1] = uplink;
                                    if ((k - col) == 1)
                                        nupbranches[i][2] = uplink;
                                }

                                if ((j - row) == 0)
                                {
                                    if ((k - col) == -1)
                                        nupbranches[i][7] = uplink;
                                    if ((k - col) == 1)
                                        nupbranches[i][3] = uplink;
                                }

                                if ((j - row) == 1)
                                {
                                    if ((k - col) == -1)
                                        nupbranches[i][6] = uplink;
                                    if ((k - col) == 0)
                                        nupbranches[i][5] = uplink;
                                    if ((k - col) == 1)
                                        nupbranches[i][4] = uplink;
                                }

                                //the current link is a downstream branch of the upstream link
                                ndownbranches[uplink][0] =
                                    ndownbranches[uplink][0] + 1;

                                //store the link number of the downstream link by its direction
                                if ((j - row) == -1)
                                {
                                    if ((k - col) == -1)
                                        ndownbranches[uplink][4] = i;
                                    if ((k - col) == 0)
                                        ndownbranches[uplink][5] = i;
                                    if ((k - col) == 1)
                                        ndownbranches[uplink][6] = i;
                                }

                                if ((j - row) == 0)
                                {
                                    if ((k - col) == -1)
                                        ndownbranches[uplink][3] = i;
                                    if ((k - col) == 1)
                                        ndownbranches[uplink][7] = i;
                                }

                                if ((j - row) == 1)
                                {
                                    if ((k - col) == -1)
                                        ndownbranches[uplink][2] = i;
                                    if ((k - col) == 0)
                                        ndownbranches[uplink][1] = i;
                                    if ((k - col) == 1)
                                        ndownbranches[uplink][8] = i;
                                }
