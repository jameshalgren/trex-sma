            ...
            for (isolid = 1; isolid <= nsolids; isolid++)
            {
                ...
                else            //else erschopt <= 1
                {
                    ...
                    for (k = 1; k <= 10; k++)
                    {
                        ...
                        outflux = outflux + advsedchoutflux[isolid][i][j][k];

                    }           //end loop over sources

                    //compute the transport rate (g/s)
                    transratech[isolid][i][j] = outflux
                        - depsedchoutflux[isolid][i][j][0];
                ...
                available =
                    vlayerch[i][j][ilayer] * csedch[isolid][i][j][ilayer];
                ...
                erssedchoutflux[isolid][i][j][ilayer] =
                    ersflowch[isolid][i][j] * csedch[isolid][i][j][ilayer];

                //set the erosion flux entering the water column (g/s)
                erssedchinflux[isolid][i][j][0] =
                    erssedchoutflux[isolid][i][j][ilayer];
