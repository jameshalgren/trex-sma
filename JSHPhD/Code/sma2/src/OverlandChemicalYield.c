...
void OverlandChemicalYield(void)
{
            ...
            if (imask[i][j] != nodatavalue)
            {
                ...
                for (iyield = 1; iyield <= ncyields; iyield++)
                {
                    ...
                    if (cyldprocess[iyield] == 1)
                    {
                        ...
                        biochemovinflux[ito][i][j][0] =
                            biochemovoutflux[ifrom][i][j][0] * cyield[iyield];

                        //compute the biodegradation reaction influx for the surface sediment
                        biochemovinflux[ito][i][j][ilayer] =
                            biochemovoutflux[ifrom][i][j][ilayer] *
                            cyield[iyield];
                    ...
                    else if (cyldprocess[iyield] == 2)
                    {
                        ...
                        hydchemovinflux[ito][i][j][0] =
                            hydchemovoutflux[ifrom][i][j][0] * cyield[iyield];

                        //compute the hydrolysis reaction influx for the surface sediment
                        hydchemovinflux[ito][i][j][ilayer] =
                            hydchemovoutflux[ifrom][i][j][ilayer] *
                            cyield[iyield];
                    ...
                    else if (cyldprocess[iyield] == 3)
                    {
                        ...
                        oxichemovinflux[ito][i][j][0] =
                            oxichemovoutflux[ifrom][i][j][0] * cyield[iyield];

                        //compute the oxidation reaction influx for the surface sediment
                        oxichemovinflux[ito][i][j][ilayer] =
                            oxichemovoutflux[ifrom][i][j][ilayer] *
                            cyield[iyield];
                    ...
                    else if (cyldprocess[iyield] == 4)
                    {
                        ...
                        phtchemovinflux[ito][i][j][0] =
                            phtchemovoutflux[ifrom][i][j][0] * cyield[iyield];

                        //compute the photolysis reaction influx for the surface sediment
                        phtchemovinflux[ito][i][j][ilayer] =
                            phtchemovoutflux[ifrom][i][j][ilayer] *
                            cyield[iyield];
                    ...
                    else if (cyldprocess[iyield] == 5)
                    {
                        ...
                        radchemovinflux[ito][i][j][0] =
                            radchemovoutflux[ifrom][i][j][0] * cyield[iyield];

                        //compute the radioactive decay reaction influx for the surface sediment
                        radchemovinflux[ito][i][j][ilayer] =
                            radchemovoutflux[ifrom][i][j][ilayer] *
                            cyield[iyield];
                    ...
                    else if (cyldprocess[iyield] == 6)
                    {
                        ...
                        vltchemovinflux[ito][i][j][0] =
                            vltchemovoutflux[ifrom][i][j][0] * cyield[iyield];

                        //compute the volatilization reaction influx for the surface sediment
                        vltchemovinflux[ito][i][j][ilayer] =
                            vltchemovoutflux[ifrom][i][j][ilayer] *
                            cyield[iyield];
                    ...
                    {
                        //compute the volatilization reaction influx for the water column
                        udrchemovinflux[ito][i][j][0] =
                            udrchemovoutflux[ifrom][i][j][0] * cyield[iyield];

                        //compute the volatilization reaction influx for the surface sediment
                        udrchemovinflux[ito][i][j][ilayer] =
                            udrchemovoutflux[ifrom][i][j][ilayer] *
                            cyield[iyield];
                    ...
                    else if (cyldprocess[iyield] == 8)
                    {
                        ...
                        dslchemovinflux[ito][i][j][0] =
                            dslsedovoutflux[ifrom][i][j][0] * cyield[iyield];

                        //compute the dissolution reaction influx for the surface sediment
                        dslchemovinflux[ito][i][j][ilayer] =
                            dslsedovoutflux[ifrom][i][j][ilayer] *
                            cyield[iyield];
