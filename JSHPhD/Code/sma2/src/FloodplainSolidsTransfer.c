...
void FloodplainSolidsTransfer(void)
{
        ...
        for (j = 1; j <= nnodes[i]; j++)
        {
            ...
            for (isolid = 1; isolid <= nsolids; isolid++)
            {
                ...
                advsedovoutflux[isolid][row][col][9] =
                    advoutflowov[row][col][9] * csedov[isolid][row][col][0];
                ...
                //
                //Overland soilds floodplain transfer potential...
                //
                ...
                {
                    //scale the soilds floodplain transfer flux (g/s) (source 9)
                    advsedovoutflux[isolid][row][col][9] =
                ...
                //Channel soilds floodplain transfer potential...
                //
                ...
                available = csedch[isolid][i][j][0] * watervolch
                    - (depsedchoutflux[isolid][i][j][0] + outflux) * dt[idt];
