...
void OverlandChemicalDeposition(void)
{
    ...
    double potential,           //chemical deposition potential (g)
            ...
            if (imask[i][j] != nodatavalue)
            {
                ...
                for (ichem = 1; ichem <= nchems; ichem++)
                {
                    ...
                    for (isolid = 1; isolid <= nsolids; isolid++)
                    {
                        ...
                        sumfp =
                            sumfp + fparticulateov[ichem][isolid][i][j][0];
                    ...
                    depchemovinflux[ichem][i][j][ilayer] =
                        depchemovoutflux[ichem][i][j][0];
