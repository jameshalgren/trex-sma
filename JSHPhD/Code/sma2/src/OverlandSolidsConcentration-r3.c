...
void OverlandSolidsConcentration(void)
{
    ...
    float sedflow,              //solids discharge (kg/s)
            ...
            if (imask[i][j] != nodatavalue)
            {
                ...
                for (isolid = 1; isolid <= nsolids; isolid++)
                {
                    ...
                    depsedovoutmass[isolid][i][j][0] =
                        depsedovoutmass[isolid][i][j][0] +
                        (float) (depsedovoutflux[isolid][i][j][0] * dt[idt] /
                                 1000.0);

                    //compute the cumulative sediment mass entering the sediment bed by deposition (kg)
                    depsedovinmass[isolid][i][j][ilayer] =
                        depsedovinmass[isolid][i][j][ilayer] +
                        (float) (depsedovinflux[isolid][i][j][ilayer] *
                                 dt[idt] / 1000.0);

                    //compute cumulative solids mass leaving the bed (kg)
                    erssedovoutmass[isolid][i][j][ilayer] =
                        erssedovoutmass[isolid][i][j][ilayer] +
                        (float) (erssedovoutflux[isolid][i][j][ilayer] *
                                 dt[idt] / 1000.0);

                    //compute the cumulative solids mass entering the water column (kg)
                    erssedovinmass[isolid][i][j][0] =
                        erssedovinmass[isolid][i][j][0] +
                        (float) (erssedovinflux[isolid][i][j][0] * dt[idt] /
                                 1000.0);

                    //Compute masses for loads (source = 0)
                    //
                    //compute the cumulative inflowing solids mass (kg)
                    advsedovinmass[isolid][i][j][0] =
                        advsedovinmass[isolid][i][j][0] +
                        (float) (advsedovinflux[isolid][i][j][0] * dt[idt] /
                                 1000.0);

                    //compute the cumulative outflowing solids mass (kg)
                    advsedovoutmass[isolid][i][j][0] =
                        advsedovoutmass[isolid][i][j][0] +
                        (float) (advsedovoutflux[isolid][i][j][0] * dt[idt] /
                                 1000.0);
                    ...
                    {
                        //compute the cumulative inflowing solids mass (kg)
                        advsedovinmass[isolid][i][j][9] =
                            advsedovinmass[isolid][i][j][9] +
                            (float) (advsedovinflux[isolid][i][j][9] *
                                     dt[idt] / 1000.0);

                        //compute the cumulative outflowing solids mass (kg)
                        advsedovoutmass[isolid][i][j][9] =
                            advsedovoutmass[isolid][i][j][9] +
                            (float) (advsedovoutflux[isolid][i][j][9] *
                                     dt[idt] / 1000.0);

                        //compute the cumulative in-dispersing solids mass (kg)
                        dspsedovinmass[isolid][i][j][9] =
                            dspsedovinmass[isolid][i][j][9] +
                            (float) (dspsedovinflux[isolid][i][j][9] *
                                     dt[idt] / 1000.0);

                        //compute the cumulative out-dispersing solids mass (kg)
                        dspsedovoutmass[isolid][i][j][9] =
                            dspsedovoutmass[isolid][i][j][9] +
                            (float) (dspsedovoutflux[isolid][i][j][9] *
                                     dt[idt] / 1000.0);
                    ...
                    //
                    //compute the cumulative inflowing solids mass (kg)
                    advsedovinmass[isolid][i][j][10] =
                        advsedovinmass[isolid][i][j][10] +
                        (float) (advsedovinflux[isolid][i][j][10] * dt[idt] /
                                 1000.0);

                    //compute the cumulative outflowing solids mass (kg)
                    advsedovoutmass[isolid][i][j][10] =
                        advsedovoutmass[isolid][i][j][10] +
                        (float) (advsedovoutflux[isolid][i][j][10] * dt[idt] /
                                 1000.0);

                    //compute the cumulative in-dispersing solids mass (kg)
                    dspsedovinmass[isolid][i][j][10] =
                        dspsedovinmass[isolid][i][j][10] +
                        (float) (dspsedovinflux[isolid][i][j][10] * dt[idt] /
                                 1000.0);

                    //compute the cumulative out-dispersing solids mass (kg)
                    dspsedovoutmass[isolid][i][j][10] =
                        dspsedovoutmass[isolid][i][j][10] +
                        (float) (dspsedovoutflux[isolid][i][j][10] * dt[idt] /
                                 1000.0);
    ...
    for (i = 1; i <= noutlets; i++)
    {
        ...
        for (isolid = 1; isolid <= nsolids; isolid++)
        {
            ...
            sedflow = (float) ((advsedovoutflux[isolid][iout[i]][jout[i]][10]
                                +
                                dspsedovoutflux[isolid][iout[i]][jout[i]][10])
                               / 1000.0);
