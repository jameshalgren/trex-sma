...
void ChannelChemicalBiodegradation(void)
{
    ...
    float kw,                   //water column reaction rate (1/s)
      ks;                       //sediment layer reaction rate (1/s)

    double potential,           //chemical biodegradation potential (g)
...
//mlv                                   kw = kbiowch[ichem] * bacteriach[i][j][0];
                    ...
                    biochemchoutflux[ichem][i][j][0] =
                        kw * cchemch[ichem][i][j][0] * watervol;
...
//mlv                                   ks = kbiosch[ichem] * bacteriach[i][j][ilayer];
                    ...
                    biochemchoutflux[ichem][i][j][ilayer] =
                        (float) (ks * cchemch[ichem][i][j][ilayer] * sedvol);
