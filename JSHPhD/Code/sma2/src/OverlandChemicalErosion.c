...
void OverlandChemicalErosion(void)
{
            ...
            if (imask[i][j] != nodatavalue)
            {
                ...
                for (ichem = 1; ichem <= nchems; ichem++)
                {
                    ...
                    for (isolid = 1; isolid <= nsolids; isolid++)
                    {
                        ...
                        erschemovoutflux[ichem][i][j][ilayer] =
                            erschemovoutflux[ichem][i][j][ilayer] +
                    ...
                    potential =
                        erschemovoutflux[ichem][i][j][ilayer] * dt[idt];
                    ...
                    available =
                        vlayerov[i][j][ilayer] *
                        cchemov[ichem][i][j][ilayer] * sumfp -
                    ...
                    pwrchemovinflux[ichem][i][j][0] =
                        pwrchemovoutflux[ichem][i][j][ilayer];
