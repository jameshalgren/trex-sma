...
void ReadSoilStackFile(void)
{
    ...
    {
        printf ("Can't open Soil Stack File : %s \n", soilstackfile);   //Write message to screen
...
//      In general, nodatavalue is -9999 but for imask it is zero...
            ...
            if (imask[i][j] > 0)
            {
                ...
                if (nstackov0[i][j] < 1)
                {
                    ...
                    fprintf (echofile_fp, "\n\n\nSoil Stack File Error:\n");
                    fprintf (echofile_fp,
                             "  Row = %d   Col = %d   nstackov0 = %d   Minimum Value = 1\n",
                             i, j, nstackov0[i][j]);
                ...
                if (nstackov0[i][j] > maxstackov)
                {
                    ...
                    fprintf (echofile_fp, "\n\n\nSoil Stack File Error:\n");
                    fprintf (echofile_fp,
                             "  Row = %d   Col = %d   nstackov0 = %d   Maximum Value = %d\n",
