...
void OverlandSolidsDeposition(void)
{
    ...
    float sigma,                //normal distribution standard deviation
      pi,                       //pi = 3.14159...
    ...
    double potential,           //solids mass deposition potential (g)
            ...
            if (imask[i][j] != nodatavalue)
            {
                ...
                for (isolid = 1; isolid <= nsolids; isolid++)
                {
                    ...
                    depflowov[isolid][i][j] =
                        depflowov[isolid][i][j] * depovscale;
                    ...
                    depsedovinflux[isolid][i][j][ilayer] =
