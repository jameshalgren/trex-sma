...
void WriteGridsWater(int gridcount)
{
    ...
    float **waterflow,          //water flow in overland and channel cells for grid 
    **waterdepth;               //water depths in overland and channel cells for grid 
    ...
    if (infopt > 0)
    {
        ...
        //ADD Call for printing of the SMA grids here. 
        //if the infopt > 1 then user specified Soil Moisture Accounting
/*		if(*SMAgrid != '\0')
		{
			//Record 
			Grid(SMAgrid, 
