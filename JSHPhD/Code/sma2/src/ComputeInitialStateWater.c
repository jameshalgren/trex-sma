...
void ComputeInitialStateWater(void)
{
    ...
    //ADD sma compute initial state
    //if Percolation with Soil Moisture Accounting is Activated
    if (infopt == 2)
    {
        //Inititial states of Soil Moisture State Variables
    }
