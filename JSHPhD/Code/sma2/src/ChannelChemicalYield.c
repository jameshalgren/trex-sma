...
void ChannelChemicalYield(void)
{
    //local variable declarations/definitions
    int ilayer,                 //index for surface layer in the sediment stack
        ...
        for (j = 1; j <= nnodes[i]; j++)
        {
            ...
            for (iyield = 1; iyield <= ncyields; iyield++)
            {
                ...
                if (cyldprocess[iyield] == 1)
                {
                    ...
                    biochemchinflux[ito][i][j][0] =
                        biochemchoutflux[ifrom][i][j][0] * cyield[iyield];

                    //compute the biodegradation reaction influx for the surface sediment
                    biochemchinflux[ito][i][j][ilayer] =
                        biochemchoutflux[ifrom][i][j][ilayer] *
                        cyield[iyield];
                ...
                else if (cyldprocess[iyield] == 2)
                {
                    ...
                    hydchemchinflux[ito][i][j][0] =
                        hydchemchoutflux[ifrom][i][j][0] * cyield[iyield];

                    //compute the hydrolysis reaction influx for the surface sediment
                    hydchemchinflux[ito][i][j][ilayer] =
                        hydchemchoutflux[ifrom][i][j][ilayer] *
                        cyield[iyield];
                ...
                else if (cyldprocess[iyield] == 3)
                {
                    ...
                    oxichemchinflux[ito][i][j][0] =
                        oxichemchoutflux[ifrom][i][j][0] * cyield[iyield];

                    //compute the oxidation reaction influx for the surface sediment
                    oxichemchinflux[ito][i][j][ilayer] =
                        oxichemchoutflux[ifrom][i][j][ilayer] *
                        cyield[iyield];
                ...
                else if (cyldprocess[iyield] == 4)
                {
                    ...
                    phtchemchinflux[ito][i][j][0] =
                        phtchemchoutflux[ifrom][i][j][0] * cyield[iyield];

                    //compute the photolysis reaction influx for the surface sediment
                    phtchemchinflux[ito][i][j][ilayer] =
                        phtchemchoutflux[ifrom][i][j][ilayer] *
                        cyield[iyield];
                ...
                else if (cyldprocess[iyield] == 5)
                {
                    ...
                    radchemchinflux[ito][i][j][0] =
                        radchemchoutflux[ifrom][i][j][0] * cyield[iyield];

                    //compute the radioactive decay reaction influx for the surface sediment
                    radchemchinflux[ito][i][j][ilayer] =
                        radchemchoutflux[ifrom][i][j][ilayer] *
                        cyield[iyield];
                ...
                else if (cyldprocess[iyield] == 6)
                {
                    ...
                    vltchemchinflux[ito][i][j][0] =
                        vltchemchoutflux[ifrom][i][j][0] * cyield[iyield];

                    //compute the volatilization reaction influx for the surface sediment
                    vltchemchinflux[ito][i][j][ilayer] =
                        vltchemchoutflux[ifrom][i][j][ilayer] *
                        cyield[iyield];
                ...
                {
                    //compute the volatilization reaction influx for the water column
                    udrchemchinflux[ito][i][j][0] =
                        udrchemchoutflux[ifrom][i][j][0] * cyield[iyield];

                    //compute the volatilization reaction influx for the surface sediment
                    udrchemchinflux[ito][i][j][ilayer] =
                        udrchemchoutflux[ifrom][i][j][ilayer] *
                        cyield[iyield];
                ...
                else if (cyldprocess[iyield] == 8)
                {
                    ...
                    dslchemchinflux[ito][i][j][0] =
                        dslsedchoutflux[ifrom][i][j][0] * cyield[iyield];

                    //compute the dissolution reaction influx for the surface sediment
                    dslchemchinflux[ito][i][j][ilayer] =
                        dslsedchoutflux[ifrom][i][j][ilayer] * cyield[iyield];
