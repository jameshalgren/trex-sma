...
void OverlandChemicalBiodegradation(void)
{
    ...
    double potential,           //chemical biodegradation mass potential (g)
...
//mlv                                           kw = kbiowov[ichem] * bacteriaov[i][j][0];
                        ...
                        biochemovoutflux[ichem][i][j][0] =
                            kw * cchemov[ichem][i][j][0] * watervol;
...
//mlv                                           ks = kbiosov[ichem] * bacteriaov[i][j][ilayer];
                        ...
                        biochemovoutflux[ichem][i][j][ilayer] =
                            (float) (ks * cchemov[ichem][i][j][ilayer] *
                                     soilvol);
