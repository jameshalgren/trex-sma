...
void ReadInitialChemicalChannelFile(void)
{
    //local variable declarations
    int ichem;                  //local loop index for number of chemicals
    ...
    float cchemtemp;            //local variable for initial chemical concentration (g/m3)
    ...
    {
        printf ("Can't open Channel Initial Suspended Chemical file: %s \n", initialchemchfile);        //Write message to screen
