...
void OverlandChemicalDissolution(void)
{
    ...
    {
        for (j = 1; j <= ncols; j++)    //loop over columns
        {
                    ...
                    if (dslopt[ichem] > 0)
                    {
                        ...
                        for (iyield = 1; iyield <= ncyields; iyield++)
                        {
                                ...
                                && cyldto[iyield] == ichem)
                            {
                                ...
                                available =
                                    csedovnew[isolid][i][j][0] * newwatervol;
                                ...
                                dslsedovoutflux[isolid][i][j][ilayer] =
                                    kd * alpha * (csol -
                                                  fdissolvedov[ichem][i][j]
                                                  [ilayer] *
                                                  cchemov[ichem][i][j]
                                                  [ilayer]);
                                ...
                                if (newsolidsmass > 0)
                                {
                                    //compute the new solids concentration after dissolution (g/m3)
                                    csedovnew[isolid][i][j][ilayer] =
                                        (float) (newsolidsmass / newsoilvol);
