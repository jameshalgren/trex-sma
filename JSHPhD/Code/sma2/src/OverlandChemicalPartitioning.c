...
void OverlandChemicalPartitioning(void)
{
        ...
        for (j = 1; j <= ncols; j++)
        {
            ...
            if (imask[i][j] != nodatavalue)
            {
                ...
                for (isolid = 1; isolid <= nsolids; isolid++)
                {
                    ...
                    fsolids =
                        fsolids +
                        csedov[isolid][i][j][0] / (float) (densityp * 1000.0);
                    ...
                    if (partopt[ichem] > 0)
                    {
                        ...
                        for (ilayer = nstackov[i][j]; ilayer >= 1; ilayer--)
                        {
                            ...
                            for (isolid = 1; isolid <= nsolids; isolid++)
                            {
                                ...
                                //       the soils is always independent
                                ...
                                if (porosityov[isoil] > 0.0)
                                {
                                    //correct partition coeffificent for porosity
                                    pic0 = pic0 / porosityov[isoil];
                                }
                                else    //else porosityov[isoil] <= 0
                                {
                                    //set the partition coefficient to effective infinity
                                    pic0 = (float) (1.0e30);
                                ...
                                //Note:  For the soil column, the particle independent
                                //       partition coefficient is used...
                                //
                            ...
                            for (isolid = 1; isolid <= nsolids; isolid++)
                            {
                                ...
                                sumfp = sumfp
                                    +
                                    fparticulateov[ichem][isolid][i][j]
                                    [ilayer];
