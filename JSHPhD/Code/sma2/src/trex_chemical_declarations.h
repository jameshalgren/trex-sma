...
extern void ChannelChemicalRadioactive(void);		//Compute chanel chemical radioactive decay
...
extern char
	...
	*totchemconcwatergridroot,	//chemical water column concentration grid root name
	*dischemconcwatergridroot,	//chemical water column concentration grid root name
	*bndchemconcwatergridroot,	//chemical water column concentration grid root name
	*prtchemconcwatergridroot,	//chemical water column concentration grid root name
	**totchemconcwatergrid,		//chemical water column concentration grid file name [ncgroups]
	**dischemconcwatergrid,		//chemical water column concentration grid file name [ncgroups]
	**bndchemconcwatergrid,		//chemical water column concentration grid file name [ncgroups]
	**prtchemconcwatergrid,		//chemical water column concentration grid file name [ncgroups]

	*totchemconcsurfgridroot,	//chemical surface layer concentration grid root name
	*dischemconcsurfgridroot,	//chemical surface layer concentration grid root name
	*bndchemconcsurfgridroot,	//chemical surface layer concentration grid root name
	*prtchemconcsurfgridroot,	//chemical surface layer concentration grid root name
	**totchemconcsurfgrid,		//chemical surface layer concentration grid file name [ncgroups]
	**dischemconcsurfgrid,		//chemical surface layer concentration grid file name [ncgroups]
	**bndchemconcsurfgrid,		//chemical surface layer concentration grid file name [ncgroups]
	**prtchemconcsurfgrid,		//chemical surface layer concentration grid file name [ncgroups]
	...
	*mblchemfracwatergridroot,	//chemical water column bound mobile grid root name
...
extern int
	...
	*ncwov,				//Number of overland chemical loads
	**cwovopt,			//Overland chemical load option (0=input as kg/day, 1=input a g/m3) [ichem]
	**cwovrow,		//Overland chemical load row number
	**cwovcol,		//Overland chemical load column number
	**ncwovpairs,	//Number of pairs (load and tme) in a overland chemical load time series
	**cwovpoint,	//pointer to current position for an overland chemical load function
...
extern float
	...
	***cwov,			//Value of an overland chemical load (kg/day) [ichem][iload][ipair]
	***cwovtime,		//Time break for an overland chemical load (hours) [ichem][iload][ipair]
	...
	*ntcwov,	//next time to update overland chemical loads (hours) [ichem]
	...
	**ncwovt,		//next (upper) interval time for overland chemical load time series
	**pcwovt,		//prior (lower) interval time for overland chemical load time series
	**bcwov,		//intercept for overland chemical load interpolation
	**mcwov,		//slope for overland chemical load interpolation
	**cwovinterp,	//temporally interpolated overland chemical load
...
extern double
	...
	*totalinfchemoutov,		//cumulative sum of chemical mass exiting water column by overland infiltration (kg) [ichem]
	*totaltnschemoutov,		//cumulative sum of chemical mass exiting water column by overland kinetics (kg) [ichem]
	...
	*totaltnscheminch,		//cumulative sum of chemical mass entering water column by channel kcheminetics (kg)
	...
	*totalinfchemoutch,		//cumulative sum of chemical mass exiting water column by channel infiltration (kg)
