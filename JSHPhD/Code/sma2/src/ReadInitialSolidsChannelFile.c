...
void ReadInitialSolidsChannelFile(void)
{
    ...
    float csedtemp;             //local variable for initial solids concentration (g/m3)
    ...
    {
        printf ("Can't open Channel Initial Suspended Solids file: %s \n", initialsschfile);    //Write message to screen
